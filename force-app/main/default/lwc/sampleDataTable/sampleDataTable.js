...
export default class sampleDataTable extends LightningElement {
    ...
    defaultValue ="G1_Product__c";
     ...
     configs=[
        {
            ...
            tableConfig: {
                columns: [
                    ...
                    { id:2,api: 'Code__c', label: 'Code', fieldName: 'Code', type: 'text', sortable: true ,section:"General Properties"},
                    
                    { id:2,api: 'Is_Active__c', label: 'Is Active', fieldName: 'Is_Active', type: 'boolean', sortable: true ,section:"General Properties"},
                    
                    { id:2,api: 'Desc__c', label: 'Desc', fieldName: 'Desc', type: 'text', sortable: true ,section:"General Properties"},
                    { id:2,api: 'Type__c', label: 'Type', fieldName: 'Type', type: 'text', sortable: true ,section:"General Properties"}
            ...
            children:[{
                ...
                tableConfig: {
                    columns: [
                        ...
                        { id:2,api: 'Code__c', label: 'Code', fieldName: 'Code', type: 'Text', sortable: true ,section:"General Properties"},
                        { id:3,api: 'Desc__c', label: 'Desc', fieldName: 'Desc', type: 'Text', sortable: true ,section:"General Properties"},
                        { id:4,api: 'Seq__c', label: 'Seq', fieldName: 'Seq', type: 'Text', sortable: true ,section:"General Properties"},
        ...
        },
        {
            ...
            tableConfig: {
                columns: [
                    ...
                    { id:2,api: 'Price__c', label: 'Price', fieldName: 'Price', type: 'currency', sortable: true ,section:"General Properties"},
        ...
        },
        {
            ...
            tableConfig: {
                columns: [
                    ...
                    { id:2,api: 'Start_Date__c', label: 'Start Date', fieldName: 'Start_Date', type: 'date', sortable: true ,section:"General Properties"},
                    { id:3,api: 'CreatedDate', label: 'Created On', fieldName: 'CreatedDate', type: 'date', sortable: true ,section:"System Properties"},
                    { id:4,api: 'CreatedBy.Name', label: 'Created By', fieldName: 'CreatedByName', sortable: true ,section:"System Properties"}
                ]
            },
     ...
     _tabTemplate={tabid:this._currentTabIndex,isSearch:true,label:"Search",showRemoveTab:false , config:this.configs[1],tableid:"dt" + this._currentTabIndex}
   ...
   // row actions
    ...
    addNewSearchTab = event =>
    {
        ...
        let newTab={tabid:this._currentTabIndex,isSearch:true,label:"Search",showRemoveTab:true , config:config,tableid:"dt" + this._currentTabIndex};
    ...
    objectListChange = event => {
      ...
      let config=this.cloneJSON(this.configs.filter( function(item){ if(item.objectName===selectedVal ) return item;})[0]);
      config.tableConfig.columns[0].typeAttributes.name=config.tableConfig.columns[0].typeAttributes.name.replace("#index#",index);
      
      config.tableConfig.columns.push({
        type: 'action',
        typeAttributes: {
            rowActions: [
                
                { label: 'View', name: "View_" + index + "_" + selectedVal},
                { label: 'Edit', name: "Edit_" + index + "_" + selectedVal},
                { label: 'Delete', name: "Delete_" + index + "_" + selectedVal}
    ...
    showNewChildForm = event =>
    {
        ...
        this.showEditFormTab(objectName,{},parentId);
    }
   ...
   cloneJSON(value)
   {
    ...
    showEditFormTab(objectName,currentRow,parentId,actionName)
    {
        ...
        {
            this.addQueryFiltertoChild(configRef, currentRow.Id);
        }
        ...
        var newTab={tabid:this._currentTabIndex,isSearch:false,actionName:true,config:configRef,label:tabLabel,row:currentRow,showRemoveTab:true,sectionWiseColumns:sectionWiseColumns,tableid:"dt" + this._currentTabIndex};
    ...
    addQueryFiltertoChild(configRef,parentId)
    {
